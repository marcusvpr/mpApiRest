...
@RestController
@RequestMapping("/api")
public class MpVersionamentoApiController {
	 ...
	 * @return ResponseEntity<Response<String>>
	 */
	@ApiOperation(value="API Header v1: Olá")
	 ...
	 * @return ResponseEntity<Response<String>>
	 */
	@ApiOperation(value="API Header v2: Olá")
